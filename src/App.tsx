...
export const routes: RouteRecord[] = [
  {
    ...
    children: [
      ...
      { path: 'cities/austin-texas', element: <CityTemplate />, loader: async () => ({ city: 'austin-texas' }) },
      { path: 'cities/houston-texas', element: <CityTemplate />, loader: async () => ({ city: 'houston-texas' }) },
      { path: 'cities/miami-florida', element: <CityTemplate />, loader: async () => ({ city: 'miami-florida' }) },
      { path: 'cities/orlando-florida', element: <CityTemplate />, loader: async () => ({ city: 'orlando-florida' }) },
      { path: 'cities/los-angeles-california', element: <CityTemplate />, loader: async () => ({ city: 'los-angeles-california' }) },
      { path: 'cities/san-diego-california', element: <CityTemplate />, loader: async () => ({ city: 'san-diego-california' }) },
      { path: 'cities/phoenix-arizona', element: <CityTemplate />, loader: async () => ({ city: 'phoenix-arizona' }) },
      { path: 'cities/las-vegas-nevada', element: <CityTemplate />, loader: async () => ({ city: 'las-vegas-nevada' }) },
      { path: 'cities/charlotte-north-carolina', element: <CityTemplate />, loader: async () => ({ city: 'charlotte-north-carolina' }) },
      { path: 'cities/atlanta-georgia', element: <CityTemplate />, loader: async () => ({ city: 'atlanta-georgia' }) },
