      ...
      <header className="border-b border-border py-4 px-6 fixed top-0 w-full bg-white/80 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 items-center text-sm font-bold uppercase tracking-wider text-primary">
            ...
            <Link to="/cities" className="text-accent">HOA Fees by City</Link>
          ...
          <Link to="/" className="bg-primary text-white text-xs md:text-sm font-bold px-4 py-2.5 rounded-full hover:bg-accent transition-colors shadow-sm">
            Calculate Fees
          </Link>
        </div>
      </header>
